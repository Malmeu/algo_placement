    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-purple-600 to-pink-500 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Algo Placement</h1>
          <p className="text-gray-600">
            {isSignUp ? 'Créer un compte administrateur' : 'Connexion administrateur'}
          </p>
        </div>
        ...
        <div className="mt-6 p-4 bg-blue-50 rounded-lg">
          <p className="text-xs text-blue-800 text-center">
            💡 <strong>Astuce :</strong> Utilisez un email contenant "admin" pour avoir les droits administrateur
          </p>
        </div>
      </motion.div>
    </div>
